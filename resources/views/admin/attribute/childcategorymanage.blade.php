                            ...
                            <div class="nk-block-head-between flex-wrap gap g-2">
                                ...
                                <div class="nk-block-head-content">
                                    <ul class="d-flex  gap-3">
                                        ...
                                        {{-- <li>
                                            <a href="#" class="btn btn-danger d-none d-md-inline-flex">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="addUserModalLabel">Add New Child Category </h4>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="childcategory" class="form-label">Name</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" id="childcategory"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select" name="category_id"
                                                                        ...
                                                                        {{ category(old('category_id'), 'select') }}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="exampleFormSelect1" class="form-label">Sub
                                                                    Category</label>
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select" name="subcategory_id"
                                                                        ...
                                                                        aria-label="Default select example">
                                                                        <option selected>Select category</option>
                                                                        {{ subcategory(old('subcategory_id'), 'select') }}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <div class="js-upload" id="dropzoneFile1">
                                                                        <div class="dz-message" data-dz-message>
                                                                            ...
                                                                            <span class="dz-message-text">recommended image
                                                                                size is 120x120</span>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $key => $val)
                                            <tr style="vertical-align: middle">
                                                ...
                                                <td>{{ category($val->category_id, 'data') }}</td>
                                                <td>{{ category($val->subcategory_id, 'data') }}</td>
                                        ...
                                        {{-- <tr>
                                            ...
                                            <td>Women</td>
                                            <td>Sharee</td>
                                            <td>Classic Sharee</td>
                                            <td>
                                                <a href="#"><img src="./images/lahenga/img_2.png"
                                                        alt=""style="width: 15%;"></a>
                                            </td>
                                            <td><span class="badge text-bg-success-soft">Active</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge text-bg-secondary-soft">Inactive</span></td>
                                            <td class="tb-col tb-col-end">
                                                <div class="dropdown">
                                                    <a href="#" class="btn btn-sm btn-icon btn-zoom me-n1"
                                                        data-bs-toggle="dropdown">
