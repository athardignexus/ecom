...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/assets/css/style.css?v1.1.1') }}">
</head>
    ...
    <div class="nk-app-root">
        ...
        <div class="nk-main">
            ...
            <div class="nk-wrap">
                                    ...
                                    <div class="col-sm-6 col-xl-6 col-xxl-3">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                ...
                                                <div class="nk-chart-analytics-session">
                                                    <canvas data-nk-chart="line" id="sessionChartAvg"></canvas>
                                                </div>
                                                <div class="chart-label-group justify-content-between mt-1">
                                                    <div class="chart-label chart-label-small">
                                                        <div class="title">1 May</div>
                                    ...
                                    <div class="col-sm-6 col-xl-6 col-xxl-3">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                ...
                                                <div class="nk-chart-analytics-session">
                                                    <canvas data-nk-chart="line" id="bounceRateChart"></canvas>
                                                </div>
                                                <div class="chart-label-group justify-content-between mt-1">
                                                    <div class="chart-label chart-label-small">
                                                        <div class="title">1 May</div>
                                                ...
                                                <div class="mt-2 mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center smaller">
                                                        <div class="change down">
                                                            <em class="icon ni ni-downward-alt-fill"></em> 12%
                                                        </div>
                                                        <span class="text-light">From last month</span>
                                                    </div>
                                                </div>
                                                <div class="nk-chart-analytics-session">
                                                    <canvas data-nk-chart="bar" id="goalCompletions"></canvas>
                                                </div>
                                                <div class="chart-label-group justify-content-between mt-1">
                                                    <div class="chart-label chart-label-small">
                                                        <div class="title">1 May</div>
                                                        ...
                                                        <div class="gap-col">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li>
                                                                        <a href="#" class="dropdown-item">7
                                                                            Days</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#" class="dropdown-item">15
                                                                            Days</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#" class="dropdown-item">30
                                                                            Days</a>
                                                                    </li>
                                                                </ul>
                                                            </div><!-- dropdown -->
                                                        </div>
                                                    </div><!-- .chart-legend-group -->
                                                </div><!-- .card-title-group -->
                                                <div class="nk-chart-analytics-audience-overview mt-3">
                                                    <canvas data-nk-chart="line" id="audienceOverviewChart"></canvas>
                                                </div>
                                            </div><!-- .card-body -->
                                        </div><!-- .card -->
                                    </div>
                                                        ...
                                                        <tr>
                                                            <td class="tb-col">
                                                                <div class="media-group">
                                                                    ...
                                                                    <div class="media-text">
                                                                        <span class="title">digital-ocean.com</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="tb-col tb-col-end">
                                            ...
                                            <div class="card-body">
                                                <div class="card-title-group">
                                                    ...
                                                    <div class="card-tools">
                                                        <em class="icon-hint icon ni ni-help-fill"
                                                            data-bs-toggle="tooltip" data-bs-placement="left"
                                                            title="Web Sessions from region"></em>
                                                    </div>
                                                </div><!-- .card-title-group -->
                                                <div class="nk-chart-analytics-session-region-map mt-3 mx-auto">
                                                    <div class="js-svgmap js-svgmap-zoom-off" id="svgWorldMap">
                                                    </div>
                                                </div><!-- .nk-chart-analytics-session-region-map -->
                                                <div
                ...
                <!-- include Footer -->
                @include('admin.layout.dashboardfooter')
                <!-- .nk-footer -->
            </div> <!-- .nk-wrap -->
        </div> <!-- .nk-main -->
    </div> <!-- .nk-app-root -->
                        ...
                        <ul class="d-flex flex-wrap gap g-2 py-2">
                            <li>
                                <div class="media media-xxl">
                                    <img src="{{ asset('dashboard/images/product/a.jpg') }}" alt=""
                                        class="img-thumbnail">
                                </div>
                            </li>
                            <li>
...
<script src="{{ asset('dashboard/assets/js/charts/analytics-chart.js') }}"></script>
