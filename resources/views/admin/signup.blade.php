...
<body>
    <main>
        <section>
            <form action="{{ route('reg_action_form'); }}" method="POST">
                @csrf
                <div class="total_div">
                    <!-----left image-->
                        ...
                        <div class="signin_input">
                            <div class="mail_input_signin">
                                <div class="input_group2 flex-nowrap">
                                    <input type="text" name="name" class="form-control" placeholder="abc@gmail.com" aria-label="Username" aria-describedby="addon-wrapping" />
                            ...
                            <div class="mail_input_signin">
                                <div class="input_group2 flex-nowrap">
                                    <input type="text" name="email" class="form-control" placeholder="abc@gmail.com" aria-label="Username" aria-describedby="addon-wrapping" />
                                    <div class="top_level2">
                                        <p>EMAIL</p>
                                    </div>
                                </div>
                            ...
                            <div class="mail_input_signin">
                                <div class="input_group2">
                                    ...
                                    <input type="text" id="password" name="password" placeholder=" " autocomplete="off" autocapitalize="off" autocorrect="off" required pattern=".{6,}" class="ControlInput ControlInput--password form-control" />
                                </div>
                            </div>
                            ...
                            <div class="mail_input_signin">
                                <div class="input_group2">
                                    ...
                                    <input type="text" id="password" name="confirm_password" placeholder=" " autocomplete="off" autocapitalize="off" autocorrect="off" required pattern=".{6,}" class="ControlInput ControlInput--password form-control" />
                                </div>
                            </div>
                            <!---option section-->
                            <div class="option_signin">
                                ...
                                <div class="forgot" name="forget">
                                    <a href="#">Forgot password?</a>
                                </div>
                            </div>
                            <div class="sign_btn">
                                <input type="submit" class="btn btn-dark" name="Sign-Up" value="Sign-Up">
